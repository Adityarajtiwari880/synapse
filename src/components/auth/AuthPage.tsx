          ...
          <div className="rounded-3xl bg-white/[0.04] border border-white/15 backdrop-blur-2xl p-7 shadow-2xl space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-500 hover:brightness-110 active:scale-95 text-white text-xs font-semibold shadow-apple-glow transition flex items-center justify-center space-x-2"
              >
